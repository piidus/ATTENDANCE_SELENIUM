...
def accept_all_application():
    ...
    for _ in range(len(rows)):
        ...
        # Find the table element by its ID
        table1 = driver.find_element(By.ID, "example")
                ...
                if sixth_td_value == "Approved/Reject":
                    ...
                    try:
                        ...
                        try:
                            ...
                            # modal = WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.CLASS_NAME, "modal.fade")))
                            ...
                            time.sleep(1)
                            # Wait for the alert to appear (assuming it has an ID like "success_msg")
                            success_msg = WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.ID, "success_msg")))
